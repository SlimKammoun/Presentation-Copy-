...
Biggest particle  & T.W                                                                                        & T.W                                                                        \\ \hline
...
\end{table}}
\begin{itemize}
\item \large{Universality for  random permutations ?}
\item \large{Independence?}
\item \large{Moments?}
\end{itemize}
...
\hline
                   & \begin{tabular}[c]{@{}l@{}}GUE + Wigner (with a good \\ control on moments)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Uniform permutation \end{tabular} \\ \hline
Biggest particle  & T.W                                                                                        & {\color{red}T.W}                                                                        \\ \hline
Edge               & Soft edge (Airy)                                                                           & Soft edge  (Airy)                                                          \\ \hline
Global convergence & Semi circular                                                                              & VKLS                                                                       \\ \hline
Fluctuations       & Gaussian  & Gaussian                                                                   \\ \hline
Bulk               & Sine process                                                                               & Discrete sine process                                                       \\ \hline
...
\hline
                   & \begin{tabular}[c]{@{}l@{}}GUE + Wigner (with a good \\ control on moments)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Uniform permutation \end{tabular} \\ \hline
Biggest particle  & T.W                                                                                        & T.W                                                                        \\ \hline
Edge               & Soft edge (Airy)                                                                           & {\color{red} Soft edge  (Airy)}                                                          \\ \hline
Global convergence & Semi circular                                                                              & VKLS                                                                       \\ \hline
Fluctuations       & Gaussian  & Gaussian                                                                   \\ \hline
Bulk               & Sine process                                                                               & Discrete sine process                                                       \\ \hline
\end{tabular}
...
Biggest particle  & T.W                                                                                        & T.W                                                                        \\ \hline
Edge               & Soft edge (Airy)                                                                           & { Soft edge  (Airy)}                                                          \\ \hline
Global convergence & Semi circular                                                                              & {\color{red}VKLS}                                                                       \\ \hline
Fluctuations       & Gaussian  & Gaussian                                                                   \\ \hline
Bulk               & Sine process                                                                               & Discrete sine process                                                       \\ \hline
\end{tabular}
\end{table}}
...
\end{lemma}
\end{frame}
\begin{frame} {Fluctuations : Kerov's central limit theorem }
\begin{theorem}[\cite*{10.1007/978-94-010-0524-1_3}]
\begin{equation*}
L_{\lambda(\sigma_n)}\left({s}{\sqrt{n}}\right)- \sqrt{n}\Omega(s) \sim \Delta(s)= \Delta(cos(\theta))=
\frac{1}{\pi}\sum_{k=2}^\infty \frac{\xi_k}{\sqrt{k}} sin(k\theta) 
\end{equation*}
...
Edge               & Soft edge (Airy)                                                                           & { Soft edge  (Airy)}                                                          \\ \hline
Global convergence & Semi circular                                                                              & VKLS                                                                       \\ \hline
Fluctuations       & Gaussian  & {\color{red}Gaussian}                                                                   \\ \hline
Bulk               & Sine process                                                                               & Discrete sine process                                                       \\ \hline
\end{tabular}
\end{table}}
\end{frame}
...
\begin{frame} {Bulk}
\begin{theorem}[\cite*{1MR1758751}]
For any $|\alpha|< 2$, under Plancherel measure,
\begin{equation*}
\{\lambda_i-i-\alpha\sqrt n\}_{i\geq1} \to Sin_\alpha.
\end{equation*}
$Sin_\alpha$ D.P.P with kernel 
\begin{equation*}
K_\alpha(x,y)=\begin{cases}
\frac{sin(arccos(\frac{\alpha}{2})(x-y))}{\pi(x-y)} & \text{ if } 
x\neq y \\ 
\frac{arcos(\frac{\alpha}{2})}{\pi} & \text{ if } x=y
\end{cases}
\end{equation*}
\end{theorem}
\footnotesize{
...
Global convergence & Semi circular                                                                              & VKLS                                                                       \\ \hline
Fluctuations       & Gaussian  & {Gaussian}                                                                   \\ \hline
Bulk               & Sine process                                                                               & {\color{red}Discrete sine process}                                                       \\ \hline
\end{tabular}
\end{table}}
\end{frame}
...
\hline
                   & \begin{tabular}[c]{@{}l@{}}GUE\\ + Wigner (with a good \\ control on moments)\end{tabular} & Plancherel                                                      & \begin{tabular}[c]{@{}l@{}l@{}}Random permutations \\ invariant under conjugation \\ (with a good control\\  on cycles' number)\end{tabular} \\ \hline
Biggest particle  & T.W                                                                                          & T.W                                                             & \cellcolor[HTML]{34FF34}T.W                                                                                 \\ \hline
...
\begin{itemize}
\large 
\item Independance  $\sim$ invarience under conjugation ?
\item Moments  $\sim$ cycles' strcture ?
\end{itemize}
\end{frame}
